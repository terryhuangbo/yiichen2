...
<div class="ny1_1">
      <?php if (get_option('mytheme_Product4')!=""): ?>                                  <!--判断语句-->
            <div style="background:url(<?php echo get_option('mytheme_Product4'); ?>) no-repeat;" class="i1">                                 <!--输出语句-->
      <?php else : ?>                                                                 <!--否定语句-->
                  ...
                  <?php if( $posts ) : ?>                                        <!--------判断如果有文章-------->
                         <ul>
                            <?php foreach( $posts as $post ) : setup_postdata( $post ); ?>      <!-------------循环开始----------->
                              ...
                              <?php else : ?> 
                                   <div class="n2">
                                        <div class="n3"><a href="#" target="_blank"><img src="<?php bloginfo('template_url'); ?>/images/yscp.jpg" /></a></div>
                                        <h2 class="n4">
