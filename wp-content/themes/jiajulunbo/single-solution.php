<?php
/**
 * Template Name: 解决方案详情页
 * Description: 
 *
 * @package WordPress
 */
get_header();
$fields = get_fields(499);
?>
...
<div class="ny1_1">
      <?php if (getVal($fields['solution_detail_background']['url'])): ?>                                  <!--判断语句-->
            <div style="background:url(<?php echo getVal($fields['solution_detail_background']['url']); ?> ) no-repeat;" class="i1">                                 <!--输出语句-->
      <?php else : ?>                                                                 <!--否定语句-->
            <div style="background:url(<?php bloginfo('template_url'); ?>/images/cp_1.jpg) no-repeat;" class="i1">
      <?php endif; ?>  
           <div class="i2">
                <div class="j1">
                <?php echo getVal($fields['solution_detail_entitle'], 'SOLUTION DETAIL'); ?>  
        </div>
                <div class="j2">
           <?php echo getVal($fields['solution_detail_title'], '解决方案'); ?> 
                </div>
           </div>
           <div class="i3">
              <?php echo getVal($fields['solution_detail_desc']); ?> 
           </div>
      </div>
</div>
<div class="ny1_2">
     ...
     <div class="ny4_1">
          <div class="o1">
               <div class="o2"><img src="<?php echo getVal($fields['solution_detail_headpic']['url']); ?>" /></div>
