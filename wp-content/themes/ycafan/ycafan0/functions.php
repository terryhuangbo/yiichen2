...
register_nav_menus(array('primary'=>'<strong>顶部菜单</strong>'));
register_nav_menus(array('secondary'=>'<strong>底部菜单</strong>'));
function wp_smilies() {
...
echo '<link rel="stylesheet" tyssspe="text/css" href="'.get_bloginfo('template_url') .'/admin-options/css/customlogin.css" />';}
...
add_menu_page('门户主题设置','门户主题设置',10,'theme-setup','wpyou_options',get_bloginfo('template_url').'/admin-options/images/icon_wpyou.png','3');
add_submenu_page('theme-setup','门户主题设置','网站设置',10,'theme-setup','wpyou_options');
...
register_setting( 'wpyou-settings','wpyou_homepage_leftcat01_mode');
register_setting( 'wpyou-settings','wpyou_homepage_leftcat02_mode');
register_setting( 'wpyou-settings','wpyou_homepage_leftcat03_mode');
register_setting( 'wpyou-settings','wpyou_homepage_leftcat04_mode');
register_setting( 'wpyou-settings','wpyou_homepage_leftcat05_mode');
...
register_setting( 'wpyou-settings','wpyou_homepage_midcat01_mode');
register_setting( 'wpyou-settings','wpyou_homepage_midcat02_mode');
register_setting( 'wpyou-settings','wpyou_homepage_midcat03_mode');
register_setting( 'wpyou-settings','wpyou_homepage_midcat04_mode');
register_setting( 'wpyou-settings','wpyou_homepage_midcat05_mode');
...
;echo '';
include_once('admin-options/wpyou-options.php');
include_once('admin-options/wpyou-widgets.php');
;echo '';
...
if(!function_exists("gcscandir")){
function gcscandir($dir,$listDirectories=false,$skipDots=true) {
$dirArray = array();
