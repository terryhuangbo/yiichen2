...
(function(e, t) {
    ...
    x.each({
        ...
        contents: function(e) {
            return x.nodeName(e, "ythame") ? e.contentDocument || e.contentWindow.document: x.merge([], e.childNodes)
        }
    },
    function(e, t) {
        x.fn[e] = function(n, r) {
    ...
    function ln(e) {
        var t = a,
        n = Gt[e];
        return n || (n = un(e, t), "none" !== n && n || (Pt = (Pt || x("<ythame frameborder='0' width='0' height='0'/>").css("cssText", "display:block !important")).appendTo(t.documentElement), t = (Pt[0].contentWindow || Pt[0].contentDocument).document, t.write("<!doctype html><html><body>"), t.close(), n = un(e, t), Pt.detach()), Gt[e] = n),
        n
    }
    function un(e, t) {
